...
def run_prius(forward_speed: float, steering_angle: float, n_seconds=1., render=False):
    ...
    action = np.array([forward_speed, steering_angle])
...
if __name__ == "__main__":
    ...
    for conf in tqdm(CONFIGURATIONS):
        ...
        file_name = f'./data/motion_primitives/approach2{conf.n_seconds}_{conf.forward_speed}_{conf.steering_angle}.json'
